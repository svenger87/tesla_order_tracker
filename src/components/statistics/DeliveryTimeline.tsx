  ...
  return (
    <div className="rounded-xl border bg-card p-4 sm:p-6">
      ...
      {/* The measured order-to-delivery average, not the four segment averages
          added up. Each segment is measured over the orders that carry its own
          two dates, and those are four different groups of people — adding them
          described a journey nobody took and printed 74 days on a page that
          says 64 a little further up. That mismatch is exactly what the forum
          feedback picked out. */}
      {(() => {
