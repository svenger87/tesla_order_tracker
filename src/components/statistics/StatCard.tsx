...
export function StatCard({ label, value, icon: Icon, description, hint, delay = 0 }: StatCardProps) {
  return (
    <motion.div
      initial={{ opacity: 0, y: 20 }}
      animate={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.4, delay }}
      className="relative overflow-hidden rounded-xl border bg-card p-3 sm:p-4 shadow-sm hover:shadow-md transition-shadow"
    >
